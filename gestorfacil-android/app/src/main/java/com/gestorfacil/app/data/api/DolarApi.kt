package com.gestorfacil.app.data.api

import com.gestorfacil.app.data.model.AlCambioResponse
import com.gestorfacil.app.data.model.BinanceRate
import com.gestorfacil.app.data.model.BolivarRate
import com.gestorfacil.app.data.model.DolarResponse
...
class DolarApi {
    ...
    suspend fun fetchRates(): BolivarRate = withContext(Dispatchers.IO) {
        try {
            ...
            // Fallback a dolarapi.com si alcambio falla
            fetchDolarApiRates()
        }
    }
    ...
    private fun fetchBinanceRates(): BinanceRate? {
        return try {
            ...
            val resp = gson.fromJson(json, com.gestorfacil.app.data.model.BinanceResponse::class.java)
            ...
            val resp2 = gson.fromJson(json2, com.gestorfacil.app.data.model.BinanceResponse::class.java)
